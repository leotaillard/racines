...
header('Location: http://10.192.81.116:8888/racines/mobile/');
?>
<!DOCTYPE html>
<html lang="fr">
    <head>
		...
		<div class="container">
			<div id="house">
				...
				<?php 
					for ($i = 0; $i < 7; $i++) {
				?>
					<div class="window" id="flat-<?php echo $i+1; ?>">
						<a href="portrait.php"><div class="absolute flat-<?php echo $i+1; ?>"></div></a>
					</div>
				<?php
					}
				?>
			...
			<div id="content">
				<video id="main-video" controls="controls" > 
				...
				<p>Nullam id dolor id nibh ultricies vehicula ut id elit. Nulla vitae elit libero, a pharetra augue. Cras mattis consectetur purus sit amet fermentum. Aenean lacinia bibendum nulla sed consectetur. Donec id elit non mi porta gravida at eget metus.</p>
				<div id="footnote"></div>
			</div>
		</div>
